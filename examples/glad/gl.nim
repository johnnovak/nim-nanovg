#[
    OpenGL loader generated by glad 0.1.36 on Sun Feb 13 13:27:10 2022.
    ...
    Commandline:
        --profile="core" --api="gl=3.2" --generator="nim" --spec="gl" --no-loader --local-files --extensions="GL_ARB_timer_query"
    Online:
        https://glad.dav1d.de/#profile=core&language=nim&specification=gl&api=gl%3D3.2&extensions=GL_ARB_timer_query
]#
