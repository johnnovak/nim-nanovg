#[
    OpenGL loader generated by glad 0.1.10a0 on Tue Mar 29 14:27:33 2016.
    ...
    Extensions:
        GL_EXT_framebuffer_multisample, GL_EXT_texture_filter_anisotropic, GL_ARB_multisample
    Loader: No

    Commandline:
        --profile="compatibility" --api="gl=4.5" --generator="nim" --spec="gl" --no-loader --extensions="GL_EXT_framebuffer_multisample,GL_EXT_texture_filter_anisotropic,GL_ARB_multisample"
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=nim&specification=gl&api=gl%3D4.5&extensions=GL_EXT_framebuffer_multisample&extensions=GL_EXT_texture_filter_anisotropic&extensions=GL_ARB_multisample
]#
...
var
  ...
  glGetTransformFeedbackiv2*: proc (xfb: GLuint, pname: GLenum, index: GLuint, param: ptr GLint) {.cdecl.}
...
proc load_GL_VERSION_4_5(load: proc) =
  ...
  glGetTransformFeedbackiv2 = cast[proc (xfb: GLuint, pname: GLenum, index: GLuint, param: ptr GLint) {.cdecl.}](load("glGetTransformFeedbackiv2"))
